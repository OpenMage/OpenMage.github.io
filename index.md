...
<div class="hero bg-dark-gradient">
    <div class="container">
        ...
        <ul class="check-list hero__checklist">
            <li>Continued Long-Term Support (LTS) from Magento 1</li>
...
<div class="container">
    <div class="info-cards row row-cols-1 row-cols-lg-3">
        <div class="col mt-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Easy Migration</h5>
                    <p class="card-text">With a sole focus on improving security, stability, and performance, migrating from an existing Magento 1 installation is easy!</p>
                </div>
                <div class="card-footer">
                    <a href="/magento-lts/migration-guide.html" class="btn btn-primary">Get Details</a>
                </div>
            </div>
        </div>
        <div class="col mt-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Install OpenMage LTS Now!</h5>
                    <p class="card-text">With composer, OpenMage installation is fast and easy!</p>
                </div>
                <div class="card-footer">
                    <a href="/magento-lts/install.html" class="btn btn-primary">Install OpenMage LTS</a>
                </div>
            </div>
        </div>
        <div class="col mt-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Official Module Library</h5>
                    <p class="card-text">OpenMage has approved a set of additional modules that are fully compatible. Check them out now!</p>
                </div>
                <div class="card-footer">
                    <a href="/magento-lts/suggested_modules.html" class="btn btn-primary">Review Modules ></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="container pb-5 pt-5">
    <h2 class="title text-center">Stay on Magento 1</h2>
    <p class="subtitle text-center w-75 mr-auto ml-auto">OpenMage LTS allows Magento 1.x EOL merchants to continue running a secure, stable Magento-based platform while remaining PCI compliant.</p>
    <div class="row mt-5">
        ...
        <div class="col-md-6 col-lg-5 mb-3">
            <h4 class="card-title">OpenMage LTS for developers</h4>
            <p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mt-2 mt-lg-5 mb-4">
                ...
                <!--iframe class="mj-w-res-iframe" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://app.mailjet.com/widget/iframe/4iX1/iBI" width="100%" height="48"></iframe-->
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <h2 class="active-info__title">
                    <span class="active-info__title-item">100 000</span> <div class="active-info__title-separator"></div>online active Magento installation
                </h2>
                <h3 class="active-info__text">
                    OpenMage LTS is designed to benefit Magento community by offering stable platform after EOL<span class="active-info__text--badge">*</span> to continue at least <span class="active-info__text--strong">5 years</span> ahead.
                </h3>
            </div>
        </div>
